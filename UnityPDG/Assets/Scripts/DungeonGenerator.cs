...
public class DungeonGenerator : MonoBehaviour, DungeonGeneratorInterface {
    ...
    public Dungeon CreateDungeon(string dungeonName, int minWidth, int maxWidth, int minHeight, int maxHeight, int roomNum)
    {
		...
		_dungeonInstance.Generate(minWidth, maxWidth, minHeight, maxHeight, roomNum, _dungeonInstance);
